    ...
    <section>
            ...
            <div class="container-center">
                ...
                <article style="padding-top: 10px">
                    <div class="container-article">
                        <img src="public/images/photos-of-works/vodoprovod-v-dome.jpg" alt="">
        ...
        <div class="container-section" id="kanalizaciya">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/kanalizaciya.jpg" alt="">
                        <h3>Прокладка канализации</h3>
        ...
        <div class="container-section" id="montag-trub">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/montag-vodoprovoda.jpg" alt="">
        ...
        <div class="container-section">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/poliv.jpg" alt="">
                        <h3>Монтаж поливки</h3>
                        <p>Производим монтаж труб поливки сада, огорода, полисадника.</p>
                        <hr>
                    </div>
                </article>
            </div>
        ...
        <div class="container-section" id="prokol">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/prokol.jpg" alt="">
        ...
        <div class="container-section" id="sanaciya">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/sanaciya.jpg" alt="">
        ...
        <div class="container-section">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/zadvigka.png" alt="">
                        <h3>Замена водопроводных задвижек</h3>
        ...
        <div class="container-section">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/zamena-krana.jpg" alt="">
                        <h3>Замена крана под давлением</h3>
                        <p>Меняем краны под давлением, если кран на врезке очень старый и не работает,
                            или с под него капает и вы понимаете что он долго не протянет,
        ...
        <div class="container-section">
            <div class="container-center">
                <article>
                    <div class="container-article">
                        <img src="public/images/photos-of-works/kolodec.jpg" alt="">
